...
td.extype = 1
td.collinear_samples = 100 # -1 for collinear SF-TDDFT
td.nstates = 5
td.positive_eig_threshold = -0.2 # unnecessary for SF-TDA
td.kernel()
...
def f(mol):
    ...
    td.extype = 1
    td.nstates = 5
    td.collinear_samples = 100
    td.positive_eig_threshold = -0.3
    td.kernel()
